...
| [variable-length](variable-length/) | The `Unknown` tail and `--min-coverage`; an `N` that only one class has. 20,870 positions unscored against 5,490 scored | 2 Fail, 1 Warning, 6 Pass | 0.80% Warning |
